...
class StatsCalculator(wikitools.analysis.common.AbstractComponentProcessor):
    NAME = 'stats'
    AUTH = 'analysis.stats'

    def __init__(self, dataRepository, options):
        self.log = logging.getLogger('StatsCalculator')
        self.dataRepository = dataRepository
        self.options = options

    def doProcess(self, comp):
        self.log.info('%s %d %d' % (comp.key, len(comp.mPages), len(comp.mLinks)))
