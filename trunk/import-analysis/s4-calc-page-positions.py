...
import getopt, logging.config, os, sys, wikitools.repo.repository, wikitools.analysis.positions
...
pagePositionCalculator = wikitools.analysis.positions.PagePositionCalculator(dataRepository)
pagePositionCalculator.processAll()
